...
# ... (Your existing code up to the function definitions)
...
class ChatbotGUI:
    def __init__(self, root):
        ...
        self.text_widget = tk.Text(self.root, wrap=tk.WORD, state=tk.DISABLED)
    ...
    def process_input(self):
        ...
        if best_match:
            ...
            self.add_message("Bot:", "I don't know the answer. Can you teach me?")
